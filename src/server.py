    ...
    def _handle_route(self, body: dict):
        try:
            ...
            _json_response(self, 200, {
                ...
                "mechanisms": decision.mechanisms,
                "confidence_gate_triggered": decision.confidence_gate_triggered,
                "confidence_gate_threshold": decision.confidence_gate_threshold,
                "selected_component_scores": decision.selected_component_scores,
                "selected_component_contributions": decision.selected_component_contributions,
                "classifier_source": classifier_source,
